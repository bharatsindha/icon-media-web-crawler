...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description='Web crawler for extracting business offering keywords from all section types',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Batch mode - crawl all pending domains (menu + services)
  python main.py

  # On-demand mode - crawl specific domain (menu + services)
...
def main():
    ...
    try:
        ...
        if args.domain:
            # On-demand mode: crawl specific domain (all section types)
            logger.info(f"Starting complete extraction for: {args.domain}")
